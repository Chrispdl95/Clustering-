# -*- coding: utf-8 -*-
"""Unsupervised_learning_Clustering (using the values of the images produced by the denoising encoder).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dO45b7ttLHJWd5xLOCZSS_ABi5U-n1iY
"""
...
model.fit(x_train_noisy, x_train, epochs=10, batch_size=64,\
          validation_data=(x_validate_noisy, x_validate), verbose=1)

# do some plotting for the reconstructed images
import matplotlib.pyplot as plt
restored_testing_dataset = model.predict(x_test_noisy)
...
for i in range(10):
    ...
    plt.gray()
fig2.savefig('noise_restored.png')
...
test_encoded_images = encoder([x_test_noisy])[0].reshape(-1,7*7*7)
